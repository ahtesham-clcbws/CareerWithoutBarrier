<nav class="main-header navbar navbar-expand-lg navbar-light">
    ...
    <ul class="navbar-nav dashboard2" id="menu1-top">
        ...
        <li class="nav-item">
            <button class="panel-heading last_p">
                <img src="<?php echo e(asset('admin/images/th_5.png')); ?>">
            </button>
            <div class="dropdown-content panel-collapse profile-noti">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span> Setting</span></a></li>
...
</nav><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/administrator/layouts/menubar.blade.php ENDPATH**/ ?>