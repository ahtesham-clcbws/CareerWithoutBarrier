            ...
            <div class="panel panel-default m-t-15">
                <div class="panel-body">
                    <div class="card alert">
                        <div class="card-body">
                            <form action="<?php echo e(route('corporate.changePassword')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('corporate.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/corporate/dashboard/changePassword.blade.php ENDPATH**/ ?>