<nav class="main-header navbar navbar-expand-lg navbar-light">
   ...
   <ul class="navbar-nav dashboard2" id="menu1-top">
      ...
      <li class="nav-item">
         ...
         <img src="<?php echo e(asset('upload/corporate/')); ?>/<?php echo e($corporate->attachment_profile); ?>">
            <?php else: ?>
...
</nav><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/corporate/layouts/corporate_menubar.blade.php ENDPATH**/ ?>