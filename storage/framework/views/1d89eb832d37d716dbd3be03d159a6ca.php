...
<script>
    var isLinux = <?php echo e($isLinux ? 'true' : 'false'); ?>;
    ...
    var phpdebugbar_plugin_vscode_onInit = function () {
        ...
        $(function onDocumentReady() {
            function getSchemeName() {
                return "<?php echo e('vscode'); ?>";
            }

            function getBasePath() {
                return "<?php echo e(str_replace('\\', '/', base_path())); ?>" + extraSlash;
            }
...
<?php /**PATH /mnt/01D9961CD1E189D0/BWS/CareerWithoutBarrier/career-without-barrier/vendor/erlangparasu/laravel-debugbar-vscode/src/Resources/vscode_debugbar_plugin.blade.php ENDPATH**/ ?>