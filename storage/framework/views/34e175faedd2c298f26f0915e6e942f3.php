...
<?php $component->withAttributes([]); ?>
    ...
    <div >
        ...
        <p align="center" style="margin-top: 10px; color:rgb(35, 33, 33); text-align:center" id='message'>
            New Contact Enquiry <?php echo e($contact->name); ?>  successfully sent!
        </p>
    </div>
    <?php $__env->startComponent('mail::button', ['url' => route('admin.contactEnquiry')]); ?>
        Click To See
...
<?php endif; ?>
<?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/mail/admin/contact_enquiry.blade.php ENDPATH**/ ?>