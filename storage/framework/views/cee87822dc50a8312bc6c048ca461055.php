                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="2" class="userImageCell">
                                                <?php if($corporate->attachment): ?>
                                                <img id="profile_img" src="<?php echo e(asset('/storage/'.$corporate->attachment)); ?>" style="width:80px;height:80px;border:1px solid #c2c2c2;">
                                                <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2"><?php echo e($corporate->address); ?>
                                                ...
                                                &nbsp;&nbsp;, <strong>City: &nbsp;</strong><?php echo e($corporate->district?->name . ', '.$corporate->state?->name); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2">
                                                ...
                                                <a href="<?php echo e(url('/storage/'.$corporate->attachment_profile)); ?>" target="_blank">
                                                    Open to View
                                                </a>
                                            </td>
                                        </tr>
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="card" id="approved-show">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mid-content">
                            <textarea id="approved-message" name="type" cols="30" rows="10"> <?php if($corporate->institude_code): ?>Please use this <?php echo e($corporate->institude_code); ?> branch code, to signup so we can go further on your request.
                            <?php endif; ?>
                            </textarea>
                        </div>
                        <div class="control-area">
