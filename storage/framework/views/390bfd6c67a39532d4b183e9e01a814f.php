...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row career_without_barrier" style="display: none;">
                        <div class="col">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="text" name="career_exams_1" class="form-control text_on_side_input" id="career_exams_1" placeholder="Enter name exam." value="<?php echo e($student->career_exams_1); ?>">
                                </div>
                                <div class="input-group-append">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="text" name="career_exams_2" class="form-control text_on_side_input" id="career_exams_2" placeholder="Enter name exam." value="<?php echo e($student->career_exams_2); ?>">
                    ...
                    <div class="col">
                        <div class="form-check mb-3 mt-2">
                            ...
                            <?php if($termsCondition): ?>          
                                <?php if(in_array(pathinfo($termsCondition->terms_condition_pdf, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp'])): ?>
                                <a href="<?php echo e(asset('home/'.$termsCondition->terms_condition_pdf)); ?>" target="_blank"> <img src="<?php echo e(asset('home/'.$termsCondition->terms_condition_pdf)); ?>" alt="termsCondition Image" style="max-width: 50px; max-height: 40px;">
                                </a>
                                <?php else: ?>
                                <a target="_blank" href="<?php echo e(asset('home/'.$termsCondition->terms_condition_pdf)); ?>">
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/student/dashboard/student_additional_details.blade.php ENDPATH**/ ?>