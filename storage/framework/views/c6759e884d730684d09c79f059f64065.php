...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input required  class="form-control" style="height:calc(2rem + 2px) !important; padding:0 0 0 3px !important" placeholder="Institude Address" name="institude_address1" value="<?php echo e($claimForm?->institude_address1); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-2">
                                    <label class="form-label">Institute Address<span class="text-danger">*</span></label>
                                    <input required class="form-control" style="height:calc(2rem + 2px) !important; padding:0 0 0 3px !important" placeholder="Institude Address" name="institude_address2" value="<?php echo e($claimForm?->institude_address2); ?>" />
                                    <?php $__errorArgs = ['institude_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input  class="form-control" style="height:calc(2rem + 2px) !important; padding:0 0 0 3px !important" placeholder="Institude Address" name="institude_address3" value="<?php echo e($claimForm?->institude_address3); ?>" />
                                    <?php $__errorArgs = ['institude_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-12 mb-2">
                                    <label class="form-label">Institute Address</label>
                                    <input class="form-control" style="height:calc(2rem + 2px) !important; padding:0 0 0 3px !important" placeholder="Institude Address" name="institude_address4" value="<?php echo e($claimForm?->institude_address4); ?>" />
                                    <?php $__errorArgs = ['institude_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/01D9961CD1E189D0/BWS/CareerWithoutBarrier/career-without-barrier/resources/views/student/dashboard/claim_scholarship.blade.php ENDPATH**/ ?>