            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link <?= $key == 0 ? 'active' : '' ?>" id="thought-tab<?php echo e($key+1); ?>" data-toggle="tab" href="#thought<?php echo e($key+1); ?>" role="tab" aria-controls="thought" aria-selected="<?= $key == 0 ? 'true' : 'false' ?>">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link " id="home-tab" data-toggle="tab" href="#section-tab<?php echo e($key+1); ?>" role="tab" aria-controls="section-tab<?php echo e($key+1); ?>" aria-selected="false">
                            <span class="mr-1 tab-icon">
                ...
                <div class="tab-content" id="myTabContent">
                    <?php $__currentLoopData = $founderThoughts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $founderThought): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane <?= $key == 0 ? ' active show ' : '' ?>" id="thought<?php echo e($key+1); ?>" role="tabpanel" aria-labelledby="thought-tab<?php echo e($key+1); ?>">
                        <div class="container">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $bannerSectionTwos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionTwo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane" id="section-tab<?php echo e($key+1); ?>" role="tabpanel" aria-labelledby="section-tab<?php echo e($key+1); ?>">
        ...
        <div class="subscribe-off comm-p-t-b">
            <div class="container">
                <div class="comm-tit-ani tit ani-tit text-left pb-2">
                    ...
                    <h2><?php echo wrapHalfTitleInSpan($bannerSectionThreeHeader?->section_title); ?><br></h2><span class="line"></span>
                    <?php endif; ?>
                </div>
                <div class="row">
...
<section>
    <div class="travel-experts single-pg-experts our-way">
        ...
        <div class="comm-tit-ani tit ani-tit">
            <h2><?php echo wrapHalfTitleInSpan($bannerSectionFourHeader?->section_title); ?><br></h2><span class="line"></span>
...
<div class="our-values">
    <div class="container">
        <div class="comm-tit-ani tit ani-tit text-center pb-2">
            ...
            <h2><?php echo wrapHalfTitleInSpan($bannerSectionFiveHeader?->section_title); ?><br></h2><span class="line"></span>
        </div>
        <div class="row">
...
<div class="our-values strategy-consult">
    <div class="container">
        <div class="comm-tit-ani tit ani-tit text-center pb-2">
            <h2><?php echo wrapHalfTitleInSpan($bannerSectionSixHeader?->section_title); ?><br></h2><span class="line"></span>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /run/media/ahtesham/Weblies/CareerWithoutBarrier/career-without-barrier/resources/views/website/aboutus.blade.php ENDPATH**/ ?>