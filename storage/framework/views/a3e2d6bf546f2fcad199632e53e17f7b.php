...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-3 col ml-auto" style="text-align: end;right: 20px;">
                  <a href="<?php echo e(route('admin.studentGenerateRollNo')); ?>" id="generateRollNumber" class="text-end btn btn-warning" style="text-decoration: none;text-align:end">Generate Roll Number</a>
                </div>
              </div>
            </form>
          </div>
      ...
      if (response.status) {
        ...
        if (data != null) {
          ...
          $.each(data, function(index, st) {
            var selected = (<?php echo e($request-> name ?? 'null'); ?> == st.id) ? 'selected' : '';
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/administrator/dashboard/studentlist.blade.php ENDPATH**/ ?>