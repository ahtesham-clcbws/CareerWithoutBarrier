                ...
                <div class="panel panel-default m-t-15">
                    ...
                    <div class="panel-body">
                        <div class="card alert">
                            <div class="card-body">
                                <form action="<?php echo e(route('admin.privacyPolicySave')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="<?php echo e(route('admin.privacyPolicyDelete', ['id' => $pros->id])); ?>">
...
<script>
    $('.toggle-status').on('change', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('privacyPolicyToggleStatus.status')); ?>",
            method: 'POST',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/administrator/dashboard/privacy_policy.blade.php ENDPATH**/ ?>