                     ...
                     <div id="content" style="position:relative;">
                        <table class="bsvtbl" border="0" cellspacing="0" cellpadding="8" width="100%" style="border-collapse:collapse;">
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td rowspan="5" colspan="2" align="center">
                                    <div class="text-center" style="display: inline-grid;">
                                       <img src="<?php echo e(url('public/upload/student/')); ?>/<?php echo e($student->photograph); ?>" class="img-fluid" style="width: 160px;border: 1px double #dee2e6;padding: 4px;height: 150px;">
                                       <img src="<?php echo e(url('public/upload/student/')); ?>/<?php echo e($student->signature); ?>" class="img-fluid" style="width: 160px;border: 1px double #dee2e6;padding: 4px;height: 60px;">
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <td colspan="4">
                                    <b>I agree for Career without Barrier’s <?php if($student->terms_conditions && $termsCondition): ?> <a href="<?php echo e(asset('public/home/'.$termsCondition->terms_condition_pdf)); ?>" target="_blank" style="text-decoration: underline;"> Terms & Conditions </a></b> &nbsp;&nbsp; &check; <?php endif; ?>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/student/dashboard/student_review.blade.php ENDPATH**/ ?>