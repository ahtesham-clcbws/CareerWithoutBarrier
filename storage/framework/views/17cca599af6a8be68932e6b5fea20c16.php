                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="userImageCell" rowspan="2">
                                                    <img id="profile_img"
                                                        src="<?php echo e(asset('/storage/' . $corporate->attachment)); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td class="information-txt" colspan="2"><?php echo e($corporate->address); ?>
                                                    ...
                                                    &nbsp;&nbsp;, <strong>City:
                                                        &nbsp;</strong><?php echo e($corporate->district?->name . ', ' . $corporate->state?->name); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="information-txt" colspan="2"><?php echo e($corporate->institute_name); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <?php if(!is_null($corporate->signup_at)): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="information-txt" colspan="2">
                                                    ...
                                                    <a href="<?php echo e(url('/storage/' . $corporate->attachment_profile)); ?>"
                                                        target="_blank">
                                                        Open to View
                                                    </a>
                                                </td>
                                    ...
                                    <div class="box-input">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input class="form-control" name="mobile" type="number"
                                                value="<?php echo e($corporate->phone); ?>" placeholder="Mobile number">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-input">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input class="form-control" name="email" type="email"
                                                value="<?php echo e($corporate->email); ?>" placeholder="E-mail">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-input">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input class="form-control" name="institude_code" type="text"
                                                value="<?php echo e($corporate->institude_code); ?>" placeholder="Institute code">
                                        </div>
                                    </div>
                                </div>
