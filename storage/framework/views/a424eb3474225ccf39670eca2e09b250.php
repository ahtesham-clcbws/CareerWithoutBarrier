                    ...
                    <div class="col-lg-5 col-md-5 col-sm-8 col-8 nav-lhs nav-rhs ml-auto">
                        <ul>
                            <li>
                                ...
                                <a href="<?php echo e(asset('home/eprospectus/'.$prospectus?->e_prospectus)); ?>">E-Prospectus
...
$termsCondition = TermsCondition::where([['status',1],['type','website']])->first();
    ...
    <div class="bottom-menu mt-5">
        <div class="container">
            <ul class="d-flex justify-content-center">
                ...
                <li><a data-toggle="modal" data-target="#instituteModel" href="javascipt:void(0)">Institute Enquiry</a></li>
                ...
                <a href="<?php echo e($termsCondition ? asset('home/'.$termsCondition->terms_condition_pdf) : 'javascipt:void(0)'); ?>" target="<?php echo e($termsCondition ? '_blank' : '_self'); ?>" >Website Terms & Conditions</a>
...
</html><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/layouts/website.blade.php ENDPATH**/ ?>