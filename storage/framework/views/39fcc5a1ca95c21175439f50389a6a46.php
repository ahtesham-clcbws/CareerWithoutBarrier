                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                ...
                                <span class="mr-1 tab-icon"><img
                                        src="<?php echo e(asset('website/assets/images/prepration/rocket-black.png')); ?>"
                                        alt="img"></span>
                                Mission
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                ...
                                <span class="mr-1 tab-icon"><img
                                        src="<?php echo e(asset('website/assets/images/prepration/light-bulb.png')); ?>"
                                        alt="img"></span>
                                Vision
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                ...
                                <span class="mr-1 tab-icon"><img
                                        src="<?php echo e(asset('website/assets/images/prepration/customer.png')); ?>"
                                        alt="img"></span>
                                Values
                            </a>
                        </li>
                                ...
                                <div class="add">
                                    <div class="custom-grid">
                                        <div class="dummy-image">
                                            <img class="img-fluid"
                                                src="<?php echo e(asset('website/assets/images/prepration/dummy-img.jpg')); ?>"
                                                alt="img">
                                        </div>
                                        ...
                                        <div class="click" data-id="specialised">
                                            <div class="cusom-tooltip-list-item">
                                                <span class="tooltip-icon me-3">
                                                    <img src="<?php echo e(asset('website/assets/images/prepration/rocket.png')); ?>"
                                                        alt="img">
                                                </span>
                                        ...
                                        <div class="click" data-id="onlineAppointement">
                                            <div class="cusom-tooltip-list-item">
                                                <span class="tooltip-icon tooltip-icon-1 me-3">
                                                    <img src="<?php echo e(asset('website/assets/images/prepration/online-learning.png')); ?>"
                                                        alt="img">
                                                </span>
                                        ...
                                        <div class="click" data-id="emergency">
                                            <div class="cusom-tooltip-list-item">
                                                <span class="tooltip-icon tooltip-icon-2 me-3">
                                                    <img src="<?php echo e(asset('website/assets/images/prepration/emergency.png')); ?>"
                                                        alt="img">
                                                </span>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 meet-experts wow-ani ani-strt">
                            <div class="maximize-value-widget">
                                <div class="maximize-icon">
                                    <img src="<?php echo e(asset('website/assets/images/prepration/icon-1.png')); ?>"
                                        alt="maximize-icon">
                                </div>
                                <h6>Strategy</h6>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 meet-experts wow-ani ani-strt">
                            <div class="maximize-value-widget">
                                <div class="maximize-icon">
                                    <img src="<?php echo e(asset('website/assets/images/prepration/icon-2.png')); ?>"
                                        alt="maximize-icon">
                                </div>
                                <h6>Mission</h6>
                                <p>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying.</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 meet-experts wow-ani ani-strt">
                            <div class="maximize-value-widget">
                                <div class="maximize-icon">
                                    <img src="<?php echo e(asset('website/assets/images/prepration/icon-3.png')); ?>"
                                        alt="maximize-icon">
                                </div>
                                <h6>Development</h6>
                                <p>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying.</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 meet-experts wow-ani ani-strt">
                            <div class="maximize-value-widget">
                                <div class="maximize-icon">
                                    <img src="<?php echo e(asset('website/assets/images/prepration/icon-4.png')); ?>"
                                        alt="maximize-icon">
                                </div>
                                <h6>Team</h6>
                                <p>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying.</p>
                ...
                <div class="row">
                    ...
                    <div class="ani-eql col-lg-3 col-md-6 meet-experts wow-ani ani-strt">
                        ...
                        <div class="travel-exp-1">
                            <h4>2019</h4>
                            <img src="<?php echo e(asset('website/assets/images/prepration/way-img-1.jpg')); ?>" alt="img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="our-values-widget d-flex">
                        <div class="our-values-icon mr-3">
                            <img src="<?php echo e(asset('website/assets/images/prepration/safety-icon-1.png')); ?>" alt="icon">
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        <div class="counter-section-icon mb-3 d-flex align-items-center justify-content-center mx-auto">
                            <img class="img-fluid" src="<?php echo e(asset('assets/images/prepration/specialist-icon-1.png')); ?>" alt="img">
                        </div>
                        <h6>Specialists</h6>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        <div class="counter-section-icon mb-3 d-flex align-items-center justify-content-center mx-auto">
                            <img class="img-fluid" src="<?php echo e(asset('assets/images/prepration/specialist-icon-2.png')); ?>" alt="img">
                        </div>
                        <h6>Happy Clients</h6>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/website/aboutus.blade.php ENDPATH**/ ?>