                                    ...
                                    <div class="course-entry">
                                        ...
                                        <div class="course-cover">
                                            <div class="course-cover-thumb">
                                                ...
                                                href="<?php echo e(route('home.career')); ?>"
                                                        aria-hidden="true">
                                                        <div class="image-wrapper"><img
                                                                src="<?php echo e(asset('website/assets/images/prepration/bank-img.jpg')); ?>"
                                        ...
                                        <div class="course-layout-content">
                                            <h3 class="course-title"><a href="<?php echo e(route('home.career')); ?>">Education
                                                    Bank Of baroda Probationary officer BOB-PO (300 Vacancies)</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/website/preparation.blade.php ENDPATH**/ ?>