...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a class="small text-muted" href="<?php echo e(route('corporatelogin')); ?>">back to login?</a>
                  </form>
                </div>
              </div>
            </div>
...
$('#forgetBtn').on('click',function(e){
            ...
            $.ajax({
                url:"<?php echo e(route('corporate.resetforgetPassword')); ?>",
                method:'post',
                data:{
                        ...
                        $('.forgetmobiledn').show();                         
                          ...
                          Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                  location = "<?php echo e(route('corporatelogin')); ?>"
                                }
                              })                         
...
</html><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/corporate/corporate_forgotpassword.blade.php ENDPATH**/ ?>