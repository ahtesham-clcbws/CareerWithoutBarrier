...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo e(asset('student/style.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/f1font-awesome.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('student/css/icheck-bootstrap.min.css')); ?>" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css" rel="stylesheet"
            integrity="sha384-uWxY/CJNBR+1zjPWmfnSnVxwRheevXITnMqoEIeG1LJrdI0GlVs/9cVSyPYXdcSF" crossorigin="anonymous">

        <link href="<?php echo e(asset('student/css/all.min.css')); ?>" rel="stylesheet">
        <!-- <link href="css/tempusdominus-bootstrap-4.min.css" rel="stylesheet"> -->
        <link href="https://cdn.jsdelivr.net/npm/admin-lte@3.1/dist/css/adminlte.min.css" rel="stylesheet">
        <!-- <link href="css/adminlte.min.css" rel="stylesheet"> -->
        <link href="<?php echo e(asset('student/css/OverlayScrollbars.min.css')); ?>" rel="stylesheet">
    ...
    <body>
        <div class="toggled" id="wrapper" style="height: -webkit-fill-available;">
            ...
            <?php echo $__env->make('student.layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('student.layouts.student_menubar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /run/media/ahtesham/Weblies/CareerWithoutBarrier/career-without-barrier/resources/views/student/layouts/master.blade.php ENDPATH**/ ?>