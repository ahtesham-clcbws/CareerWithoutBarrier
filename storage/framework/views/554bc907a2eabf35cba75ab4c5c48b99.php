...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-6 col mb-3">
                     ...
                     <select name="state_id" class="form-control form-select" id="state" onchange="selectDisctrict(this.value)" required>
                        ...
                        <option value="<?php echo e($state->id); ?>" <?php echo e($student->state_id == $state->id ? 'selected' : ''); ?>><?php echo e($state->name); ?></option>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/student/dashboard/studentform.blade.php ENDPATH**/ ?>