    ...
    <section class="content admin-1">
        <div class="row corporate-cards">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="2" class="userImageCell">
                                                <img id="profile_img" src="<?php echo e(asset('/public/upload/corporate/'.$corporate->attachment)); ?>" style="width:80px;height:80px;border:1px solid #c2c2c2;  ">
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <div class="col-md-6 col-12">
                ...
                <?php if($corporate->signup_approved == 0): ?>
                                ...
                                <div class="box-input">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="<?php echo e($corporate->name); ?>" placeholder="Person name">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-input">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" name="institute_name" class="form-control"
                                            value="<?php echo e($corporate->institute_name); ?>" placeholder="Institute name">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-input">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="number" class="form-control" placeholder="Mobile number"
                                            value="<?php echo e($corporate->phone); ?>" name="mobile">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <div class="box-input">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="email" class="form-control" value="<?php echo e($corporate->email); ?>"
                                ...
                                <div class="box-input">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" class="form-control" placeholder="Institute code"
                                            value="<?php echo e($corporate->institude_code); ?>" name="institude_code">
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/administrator/dashboard/institude/institude_list_signup_view.blade.php ENDPATH**/ ?>