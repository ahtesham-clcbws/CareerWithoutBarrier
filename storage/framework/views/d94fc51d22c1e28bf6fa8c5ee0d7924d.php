...
if ($student->state_id) {
   $state = DB::table('states')->where('id', $student->state_id)->first()?->StateName;
}
...
<div class="container pagecontentbody">
   <div class="tab-content">
      <div class="pagebody p-4">
         <div class="row">
            <div class="col-md-9">
               <a class="btn btn-info float-left Exam" href="<?php echo e(route('studentDashboard')); ?>" style="width: 6rem;
    height: 2.65rem;">
                        ...
                        <table class="bsvtbl" border="0" cellspacing="0" cellpadding="8" width="100%" style="border-collapse:collapse;">
                           <thead>
                              <tr>
                                 <th colspan="4">
                                    <div style="padding: 0 15px 10px; margin-bottom: 10px; border-bottom: 2px solid #000; position: relative;">
                                       <img src="<?php echo e(asset('assets/images/logo.png')); ?>" style="width: 60px; height: auto; position: absolute; top: 0px; left: 20px;" />
                              ...
                              <tr class="dn" >
                                 ...
                                 <th colspan="2" style="text-align: right; font-size: 10pt;"><strong>Printed On : </strong> <?php echo e(date('d/m/Y h:ia')); ?></th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php echo e($student->district?->DistrictName); ?>
                              ...
                              <tr>
                                 ...
                                 <td  colspan="2">
                                    <?php echo e($student->scholarship_category ?? 'N/A'); ?>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php echo e($student->scholarship_opted_for ?? 'N/A'); ?>
                                 ...
                                 <td  colspan="2">
                                    <?php echo e($student->choiceCenterA?->DistrictName ?? 'N/A'); ?>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php echo e($student->choiceCenterB?->DistrictName ?? 'N/A'); ?>
                              ...
                              <tr>
                                 ...
                                 <td>Father: &nbsp;&nbsp;<?php echo e($student->father_occupation); ?> <br>
                                    Mother: &nbsp;&nbsp;<?php echo e($student->mother_occupation); ?>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php if($student->terms_conditions): ?> &check; <?php else: ?> No <?php endif; ?>
                                 </td>
                                 <td>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/student/dashboard/student_review.blade.php ENDPATH**/ ?>