                            ...
                            <div class="card-body text-center">
                                <form action="<?php echo e(route('razorpay.payment.store')); ?>" method="POST">
                                    ...
                                    <script src="https://checkout.razorpay.com/v1/checkout.js"
                                        data-key="<?php echo e(env('RAZORPAY_KEY')); ?>" data-amount="<?php echo e($feeAmount); ?>00"
                                        data-currency="INR"
                                        data-buttontext="Pay <?php echo e($feeAmount); ?> INR" data-name="Programming Solutions"
...
<?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/payment/razorpay.blade.php ENDPATH**/ ?>