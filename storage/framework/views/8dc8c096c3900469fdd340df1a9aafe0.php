...
<table id="customers" style="width:95%;">
  ...
  <?php $__currentLoopData = $institute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institutes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
    <tr>
        ...
        <td>
                    <?php echo e(date('d/m/Y h:i:s A', strtotime($institutes->created_at))); ?>
...
<?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/administrator/download/print-approve-institute-list.blade.php ENDPATH**/ ?>