...
<?php $component->withAttributes([]); ?>
    ...
    <div >
        ...
        <p align="center" style="margin-top: 10px; color:rgb(35, 33, 33); text-align:center" id='message'>
            The Student <b><?php echo e($student->name); ?></b>  <?php echo e($studentCode->used_coupon ? 'Used Coupon Code ' : 'Payment Done '); ?> successfully!
        </p>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/mail/admin/student_payment.blade.php ENDPATH**/ ?>