...
<div class="row px-3">
  ...
  <div class="col-lg-12">
    <div class="row justify-content-space-between py-3">
      ...
      <div class="col-md-6 col">
        <a href="<?php echo e(route('admin.refreshStudentRank')); ?>" class="btn-warning btn float-right">Student Rank Refresh</a>
      </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo e(route('admin.student.result.detail', $student->id)); ?>" class="btn btn-primary" style="text-decoration: none; text-align:center"></i> Result</a>
                        <br>
                        <a href="<?php echo e(route('admin.student.adminCard', $student->id)); ?>" class="btn btn-primary" style="text-decoration: none;     width: 104px;
    margin-top: 10px;"></i> Admit Card</a>
                      ...
                      <td style="text-align:center">
                        ...
                        <!-- <?php endif; ?> -->
                        <?php if($student->latestStudentCode?->percentage < 60): ?> <a href="#" class="btn btn-warning text-danger" style="text-decoration: none; width: 94px; margin-bottom: 10px;"></i> Not Eligible</a>
                          <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/administrator/dashboard/student_result.blade.php ENDPATH**/ ?>