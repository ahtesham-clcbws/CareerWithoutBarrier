                ...
                <div class="row">
                    ...
                    <div class="ml-md-auto col-12 col-sm-8 col-md-5 col-lg-5 nav-lhs nav-rhs">
                        <ul>
                            ...
                            <li><a class="book-btn" href="<?php echo e(route('registration')); ?>">Sign Up<span class="fa fa-long-arrow-right" aria-hidden="true"></span></a></li>
                            <?php endif; ?>
                ...
                <div class="row">
                    <div class="menu-top">
                        ...
                        <div class="col-lg-2 col-md-4 menu-top3 text-right menu" style="padding-right: 0;">
                            <a href="<?php echo e(route('freeform')); ?>" style="text-decoration: underline; font-size: 12px; font-weight: 900; color: #ba2af7;">Get Discount Voucher</a>
                        </div>
                    </div>
                </div>
            </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2491896938-0', $__slots ?? [], get_defined_vars());
...
</html><?php /**PATH /run/media/ahtesham/Projects/BWS/0_PROJECTS/CareerWithoutBarrier/career-without-barrier/resources/views/layouts/website.blade.php ENDPATH**/ ?>