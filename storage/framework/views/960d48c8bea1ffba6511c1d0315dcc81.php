...
<style>
    ...
    @media screen and (min-width: 769px) {
        .responsive-item {
            width: calc(100% / <?php echo e(count($educations)); ?>) !important; /* Divide width based on number of items */
        }
    }
</style>
                ...
                <div class="row">
                    ...
                    <div class="ban-box">
                        <ul>
                            ...
                            <li style="" class="responsive-item">
                                <div class="ban-box-com <?php echo e(( $key==0)? 'act':""); ?>">
                                    <img src="<?php echo e(asset('public/website/assets/images/icons/diploma.png')); ?>" alt="">
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/website/homepage.blade.php ENDPATH**/ ?>