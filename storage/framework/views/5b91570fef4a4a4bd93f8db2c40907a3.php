                ...
                <div class="row">
                    ...
                    ?>
                        <div class="features-foter">
                            ...
                            <p><a href="<?php echo e($imp_link ? asset('public/home/'.$imp_link->terms_condition_pdf) : 'javascipt:void(0)'); ?>" target="<?php echo e($imp_link ? '_blank' : '_self'); ?>">Important Links</a></p>
                            <!--<p><a href="javascipt:void(0)">Downloads</a></p>-->
                            <p><a href="<?php echo e($privacy_policy ? asset('public/home/'.$privacy_policy->terms_condition_pdf) : 'javascipt:void(0)'); ?>" target="<?php echo e($termsCondition ? '_blank' : '_self'); ?>" >Website Privacy Policy</a></p>
                            <p><a href="<?php echo e($termsCondition ? asset('public/home/'.$termsCondition->terms_condition_pdf) : 'javascipt:void(0)'); ?>" target="<?php echo e($termsCondition ? '_blank' : '_self'); ?>" >Website Terms & Conditions</a>
                            </p>
                            <p><a href="<?php echo e(URL::to('homepage/faq')); ?>">Faq</a></a>
                            </p>
                        </div>
                    </div>
...
</html><?php /**PATH /home/u482032683/domains/careerwithoutbarrier.com/public_html/resources/views/layouts/website.blade.php ENDPATH**/ ?>