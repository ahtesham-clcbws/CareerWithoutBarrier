...
<nav class=" sidebar navbar-inverse fixed-top elevation-4" id="sidebar-wrapper" role="navigation" style="overflow-y: hidden;  font-style: italic !important;">
   <div class="sidebar-header">
      ...
      <div class="logo_area mb-2">
         ...
         <img src="<?php echo e(asset('upload/corporate/')); ?>/<?php echo e($corporate->attachment_profile); ?>" alt="Prifle Dp" class="brand-image img-circle elevation-3" style="opacity: .8">
            <?php else: ?>
...
<!-- /#sidebar-wrapper --><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/corporate/layouts/sidebar.blade.php ENDPATH**/ ?>