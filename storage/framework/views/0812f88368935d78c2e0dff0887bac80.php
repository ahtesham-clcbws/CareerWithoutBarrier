            ...
            <tr style="height:24pt">
               ...
               <td style="width:133pt;" class="tb1">
                  <p class="s10" style="padding: 9pt;padding-left: 10pt;text-indent: 0pt;text-align: left;">
                     <?php echo e($student->scholarship_category ?? 'NA'); ?>
            ...
            <tr style="height:25pt">
               ...
               <td style="width:133pt" class="tb1">
                  <p class="s10" style="padding: 9pt;padding-left: 13pt;text-indent: 0pt;text-align: left;">
                     <?php echo e($student->scholarship_opted_for ?? 'NA'); ?>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/student/dashboard/result_download.blade.php ENDPATH**/ ?>