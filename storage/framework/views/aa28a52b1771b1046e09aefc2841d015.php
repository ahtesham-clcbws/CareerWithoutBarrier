              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e($students->dob); ?></td>
                    <td class="color-primary"><?php echo e($students->id); ?></td>
                    <td style="text-align:center">
                      <a href="<?php echo e(route('adminDashboard', $students->id)); ?>" class="btn btn-primary" style="text-decoration: none;"></i> View</a>
                      <!-- <ul style="list-style: none;">
                        <li class="card-option drop-menu">
                          ...
                          <ul class="card-option-dropdown dropdown-menu">
                            <li><a href="<?php echo e($students->id); ?>"><i class="ti-loop"></i> Edit</a></li>
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/administrator/dashboard/studentlist.blade.php ENDPATH**/ ?>