...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo e(asset('admin/css/icheck-bootstrap.min.css')); ?>" rel="stylesheet">
        ...
        <link href="<?php echo e(asset('admin/css/all.min.css')); ?>" rel="stylesheet">

        <link href="<?php echo e(asset('admin/css/icheck-bootstrap.min.css')); ?>" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/npm/admin-lte@3.1/dist/css/adminlte.min.css" rel="stylesheet">

        <link href="<?php echo e(asset('admin/css/OverlayScrollbars.min.css')); ?>" rel="stylesheet">
    ...
    <body>
        <div class="toggled" id="wrapper">
            ...
            <?php echo $__env->make('administrator.layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('administrator.layouts.menubar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /run/media/ahtesham/Weblies/CareerWithoutBarrier/career-without-barrier/resources/views/administrator/layouts/master.blade.php ENDPATH**/ ?>