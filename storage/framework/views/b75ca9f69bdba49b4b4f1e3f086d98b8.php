            ...
            <div class="row" style="padding-top:85px;padding-bottom:85px">
                ...
                <div class="col-10 width centerContent" style="text-align: justify;">
                    <div class="d-flex flex-column justify-content-between h-100">
                        ...
                        <div class="width">
                            <h4 class="mb-0"><?php echo e($course?->course_full_name); ?> (<?php echo e($course?->title); ?>)</h4>
                        </div>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/01D9961CD1E189D0/BWS/CareerWithoutBarrier/career-without-barrier/resources/views/website/career.blade.php ENDPATH**/ ?>