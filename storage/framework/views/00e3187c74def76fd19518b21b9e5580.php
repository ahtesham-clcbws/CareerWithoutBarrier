    ...
    <div class="panel panel-default m-t-15">
      ...
      <div class="panel-body p-3">
        <div class="card alert">
          <div class="card-body ">
          <a href="<?php echo e(route('print.approve.institute.list')); ?>" target="blank" class="btn btn-primary btn-small">Print PDF</a>
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/01D9961CD1E189D0/BWS/CareerWithoutBarrier/career-without-barrier/resources/views/administrator/dashboard/institude/institude_list.blade.php ENDPATH**/ ?>