<nav class="main-header navbar navbar-expand-lg navbar-light">
   ...
   <ul class="navbar-nav dashboard2" id="menu1-top">
      ...
      <!-- <li class="nav-item" style="margin-right: 3px;">
         <button class="panel-heading"> <i class="fa fa-file-text"></i> <span class="qty">5</span> </button> 
         <div class="dropdown-content panel-collapse noti_box" style="display: none;">
            <div class="profile-box"> <span class="notif_text">New notifications (5)</span> <span class="all_read">Mark all read</span> </div>
            <ul>
               <li> <a href="#"> <img src="<?php echo e(asset('student/images/watch.png')); ?>" class="noti_icon"> <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details<span> </span></span></a> </li>
               <li> <a href="#"> <img src="<?php echo e(asset('student/images/watch.png')); ?>" class="noti_icon"> <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details<span> </span></span></a> </li>
               <li> <a href="#"> <img src="<?php echo e(asset('student/images/watch.png')); ?>" class="noti_icon"> <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details<span> </span></span></a> </li>
               <li> <a href="#"> <img src="<?php echo e(asset('student/images/watch.png')); ?>" class="noti_icon"> <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details<span> </span></span></a> </li>
               <li> <a href="#"> <img src="<?php echo e(asset('student/images/watch.png')); ?>" class="noti_icon"> <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details<span> </span></span></a> </li>
      ...
      <!-- <li class="nav-item">
         <button class="panel-heading"> <i class="fa fa-heart" aria-hidden="true"></i> <span class="qty">3</span> </button> 
         <div class="dropdown-content panel-collapse noti_box right_align no_radi no_radi2" style="display: none;">
            <div class="profile-box">
               <div class="asu_area">
                  <div class="row">
                     <div class="col-md-6 col-6"> -->
                        <!-- <span class="assu_text">Assured by</span> <img src="images/Logo.png"> ---> 
                        <!-- <div class="asu_area2"> <span class="my_wh">My Wishlist (3)</span> <span class="link_p">Liked products</span> </div>
                     </div>
                     <div class="col-md-6 col-6"> <a href=""><i class="fa fa-heart heart_ic" aria-hidden="true"></i></a> </div>
                  </div>
               </div>
            </div>
            <ul>
               <li>
                  <a href="#">
                     ...
                     <div class="menu_txt_area">
                        <span class="noti_text"> Course Package / Book Name Details</span> <span class="sub_text">Further Details</span> 
                        <div class="rat_star_area"> <span class="rat_st">4.1 </span> <i class="fa fa-star-o" aria-hidden="true"></i> </div>
                        <span class="view_pe">(2149)</span> <img src="images/Logo.png" class="mini_ye"> 
                     </div>
                     <div class="wh_ic_area"> <i class="fa fa-trash-o" aria-hidden="true"></i> <i class="fa fa-cart-arrow-down" aria-hidden="true"></i> </div>
                  </a>
               </li>
               <li>
                  <a href="#">
      ...
      <li class="nav-item">
         <button class="panel-heading last_p"> <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="qty">3</span> </button> 
      ...
      <?php use Illuminate\Support\Facades\Auth; $user = Auth::guard('student')->user(); ?> 
      <li class="nav-item">
         <button class="panel-heading last_p"> <img src="<?php echo e(asset('student/images/th_5.png')); ?>"> </button> 
...
</nav><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/student/layouts/student_menubar.blade.php ENDPATH**/ ?>