...
<div class="row py-2 pl-3 pr-3">
    <div class="container ">
        <div class="row">
            <div class="col-lg-6">
                <div class="panel panel-default m-t-15">
                    <div class="card-header">
                        <h5> Add Terms and Condition PDF:</h5>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card-header">
                    <h3>Terms Condition PDF List</h3>
                </div>
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <td>
                                            <div style="text-align: center;">
                                                ...
                                                <a href="<?php echo e(asset('home/'.$pros->terms_condition_pdf)); ?>" target="_blank"> <img src="<?php echo e(asset('home/'.$pros->terms_condition_pdf)); ?>" alt="Prospectus Image" style="max-width: 50px; max-height: 40px;">
                                                    ...
                                                    <?php else: ?>
                                                    <a target="_blank" href="<?php echo e(asset('home/'.$pros->terms_condition_pdf)); ?>">
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/administrator/dashboard/terms_condition.blade.php ENDPATH**/ ?>