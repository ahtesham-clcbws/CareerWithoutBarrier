...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col-md-3">
                <a class="btn btn-info Exam float-end" href="<?php echo e(route('home')); ?>" style="width: 6rem; height: 2.65rem;">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="card">
                                    <div class="d-flex justify-content-between align-items-center p-2"
                                        ...
                                        <a href="<?php echo e(route('admin.print.studentView', $student->id)); ?>"
                                            ...
                                            <div class="table-responsive">
                                                <table class="table-bordered table-hover table" id="studentTable">
                                                    <tbody>
                                                        <tr>
                                                            <td><b>Name</b></td>
                                                            <td class="information-txt" colspan="2"><?php echo e($student->name); ?>

                                                            </td>
                                                            <td class="userImageCell" rowspan="3" colspan="2">
                                                                <img class="img-fluid"
                                                                    src="<?php echo e($student->photograph ? '/storage/' . $student->photograph : '/student/images/th_5.png'); ?>"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="information-txt" colspan="2">
                                                                <?php echo e($student->mobile); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>Email ID</b></td>
                                                            <td class="information-txt" colspan="2"><?php echo e($student->email); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="information-txt" colspan="3">
                                                                <?php echo e($student->address); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="information-txt"><b>City</b></td>
                                                            <td class="information-txt">
                                                                <?php echo e($student->district?->name); ?> / <?php echo e($student->pincode); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="information-txt">
                                                                <?php echo e($student->qualifications?->name ?? 'N/A'); ?> </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="information-txt">
                                                                <?php echo e($student->scholarShipOptedFor?->name ?? 'N/A'); ?></td>
                                                            <td>
                                                            ...
                                                            <td class="information-txt">
                                                                ...
                                                                <?php echo e($center?->name); ?> <?php if($student->choiceCenterB): ?>
                                                                    <?php ($center2 = DB::table('districts')->where('id', $student->test_center_b)->first()); ?>
                                                                    <br /><b>B:</b> <?php echo e($center2->name); ?>
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /run/media/ahtesham/Projects/BWS/0_PROJECTS/CareerWithoutBarrier/career-without-barrier/resources/views/administrator/dashboard/student_view.blade.php ENDPATH**/ ?>