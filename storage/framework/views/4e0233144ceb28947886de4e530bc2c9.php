                    ...
                    <div class="filter-categories-widget">
                        <form action="https://demoapus1.com/skillup/lp-courses/" method="get">
                            <ul class="course-category-list course-list-check">
                                ...
                                <li>
                                    <input id="filter-category-42" class="d-none" type="radio" name="filter-category" value="<?php echo e($course->id); ?>" <?= $course->is_featured ==1 ? 'checked' : '' ?>>
                                        ...
                                        <div class="course-cover-thumb">
                                            <figure class="entry-thumb"><a class="post-thumbnail" href="<?php echo e(route('home.career',encodeId($featuredCourse->id))); ?>" aria-hidden="true">
                                                    <div class="image-wrapper">
                                                        <center><img src="<?php echo e(asset('home/course/'.$featuredCourse->featured_image)); ?>" style="width:250px;height:250px;" class="img-fluid" alt=""></center>
                                                    </div>
                                                </a></figure>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/01D9961CD1E189D0/BWS/CareerWithoutBarrier/career-without-barrier/resources/views/website/preparation.blade.php ENDPATH**/ ?>