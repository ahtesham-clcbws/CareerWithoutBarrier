        ...
        <center>
            <table style="border-collapse:collapse;margin-left:6.3494pt" cellspacing="0">
                ...
                <tr style="height:24pt">
                    ...
                    <td style="width:133pt;" class="tb1">
                        <p class="s10 sansita" style="padding-top: 7pt;padding-left: 10pt;text-indent: 0pt;text-align: left;"> <?php echo e($student->scholarship_category ?? 'NA'); ?></p>
                    </td>
                </tr>
                <tr style="height:25pt">
                    <td style="width:93pt;" class="tb1">
                    ...
                    <td style="width:133pt;" class="tb1">
                        <p class="s10" style="padding-top: 8pt;padding-left: 13pt;text-indent: 0pt;text-align: left;"><?php echo e($student->scholarship_opted_for ?? 'NA'); ?></p>
                    </td>
                </tr>
...
<?php echo $__env->make('student.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/student/dashboard/admitCard.blade.php ENDPATH**/ ?>