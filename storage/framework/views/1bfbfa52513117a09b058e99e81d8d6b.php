...
<div class="row">
  <div class="col-lg-8 col-md-8 col" style="margin-left: auto;margin-right:auto">
    ...
    <table class="table table-striped datatablecl" style="width:100%">
      ...
      <tbody class="table-striped table-striped-coupon">
        ...
        <tr>
          ...
          <td style="font-size: 13px"><?php echo e($coupon->status ? 'Active' : 'Inactive'); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </tbody>
    </table>
...
<?php echo $__env->make('administrator.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lkaj6m2w9cvv/public_html/resources/views/administrator/dashboard/corporate_coupon_list.blade.php ENDPATH**/ ?>