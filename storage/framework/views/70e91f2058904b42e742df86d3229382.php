    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="scolarship-leftpanel-widget d-flex" data-target="content<?php echo e($key+1); ?>" style="cursor: pointer;">
                        ...
                        <div class="scolarship-leftpanel-content text-center">
                            <div class="career-logo">
                                <img class="img-fluid" src="<?php echo e(asset('website/assets/images/prepration/career-logo.jpg')); ?>" alt="img">
                            </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-12">
                <?php $__currentLoopData = $scholarShips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $scholarShip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="scolarship-rightpanel-content text-center content<?php echo e($key+1); ?>" style="<?php echo e($key == 0 ? '' : 'display:none'); ?>">
...
<div class="career-overview career-overview-content content<?php echo e($key+1); ?>" style="<?php echo e($key == 0 ? '' : 'display:none'); ?>">
    <div class="container">
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u482032683/domains/develop.testandnotes.com/public_html/resources/views/website/scholarship.blade.php ENDPATH**/ ?>