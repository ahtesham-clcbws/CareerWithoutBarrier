...
function institudeCodeGenerate($institudeNamte)
{
	...
	$result = strtoupper($firstLetters) . $randomNumber;
...
if (!function_exists('wrap_half_title_in_span')) {
	function wrap_half_title_in_span($title)
	{
		$words = explode(' ', $title);
