                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" placeholder="Please enter old password...">
                                </div>

                                <div class="form-group">
                                    <label>New Password</label>
                                    <input type="password" class="form-control" placeholder="Please enter new password to create...">
                                </div>
