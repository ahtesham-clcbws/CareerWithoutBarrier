...
@section('content')
    <div id="jssor_1"
        ...
        <div data-u="slides"
            ...
            <img data-u="image" style="opacity:0.8;" data-src="assets/images/slider/banner-5.jpg" />
            <div data-ts="flat" data-p="275" data-po="40% 50%" style="left:150px;top:40px;width:800px;height:300px;position:absolute;">
                <div data-to="50% 50%" data-t="0" style="left:50px;top:520px;width:400px;height:100px;position:absolute;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">Scholarship</div>
                <div data-to="50% 50%" data-t="1" style="left:50px;top:540px;width:400px;height:100px;position:absolute;opacity:0.5;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">Scholarship</div>
                <div data-to="50% 50%" data-t="2" style="left:50px;top:560px;width:400px;height:100px;position:absolute;opacity:0.25;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">Scholarship</div>
                <div data-to="50% 50%" data-t="3" style="left:50px;top:580px;width:400px;height:100px;position:absolute;opacity:0.125;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">Scholarship</div>
                <div data-to="50% 50%" data-t="4" style="left:50px;top:600px;width:400px;height:100px;position:absolute;opacity:0.06;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">Scholarship</div>
                <div data-to="50% 50%" data-t="5" style="left:50px;top:710px;width:700px;height:100px;position:absolute;color:#f0a329;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">NAME</div>
            </div>
        </div> -->
            <!-- <div>
            <img data-u="image" data-src="assets/images/slider/banner-2.jpg" />
            <div data-ts="flat" data-p="540" data-po="40% 50%" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                <div data-to="50% 50%" data-ts="preserve-3d" data-t="6" style="left:350px;top:360px;width:900px;height:500px;position:absolute;">
                    <svg viewbox="0 0 800 60" data-to="50% 50%" width="800" height="60" data-t="7" style="left:0px;top:-70px;display:block;position:absolute;opacity:0;font-family:'Roboto Condensed',sans-serif;font-size:60px;font-weight:700;letter-spacing:0.05em;overflow:visible;">
                        <text fill="#454447" stroke="#ff9500" stroke-width="2" text-anchor="middle" x="400" y="60">Lorem ipsum
                        </text>
                    </svg>
                    <div data-to="50% 50%" data-t="8" style="filter:url('#jssor_1_flt_1');left:200px;top:0px;width:600px;height:60px;position:absolute;opacity:0;color:#C49D8F;font-family:Roboto Condensed, sans-serif;font-size:48px;line-height:1.2;letter-spacing:0.1em;text-align:center;">is placeholder text</div>
                    <svg viewbox="0 0 800 100" width="800" height="100" data-t="9" style="left:40px;top:250px;display:block;position:absolute;opacity:0;font-family:'Roboto Condensed',sans-serif;font-size:100px;font-weight:900;letter-spacing:0.5em;overflow:visible;">
                        <text fill="rgba(255,255,255,0.7)" stroke="#ff9500" text-anchor="middle" x="400" y="100">commonly used
                        </text>
                    </svg>
                </div>
            </div>
            ...
            <div style="background-color:#000000;">
                <img data-u="image" style="opacity:0.8;"
                    data-src="{{ asset('website/assets/images/slider/banner-1.jpg') }}" />
                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                    ...
                    <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="11"
                        ...
                        <text fill="#fafbfc" text-anchor="middle" x="400" y="72">Lorem ipsum
                        </text>
                    </svg>
                    <svg viewbox="0 0 800 72" data-to="50% 50%" width="800" height="72" data-t="12"
                        ...
                        <text fill="#fafbfc" text-anchor="middle" x="400" y="72">is placeholder
                        </text>
                    </svg>
                </div>
            </div>
            <!-- <div>
            <img data-u="image" data-src="assets/images/slider/banner-4.jpg" />
            <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                <div data-to="50% 50%" data-t="13" style="left:100px;top:-20px;width:800px;height:200px;position:absolute;opacity:0;">
                    <div style="left:94px;top:35px;width:480px;height:90px;position:absolute;color:rgba(74,217,205,0.5);font-family:'Roboto Condensed',sans-serif;font-size:72px;line-height:1.2;">From </div>
                    <div style="left:307px;top:115px;width:400px;height:50px;position:absolute;color:rgba(74,217,205,0.5);font-family:'Roboto Condensed',sans-serif;font-size:42px;line-height:1.1;text-align:center;background-color:rgba(72,77,76,0.5);">its medieval</div>
                </div>
            </div>
        </div> -->
            <div>
                <img data-u="image" data-src="{{ asset('website/assets/images/slider/banner-3.jpg') }}" />
                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                        ...
                        <ul>
                            <li>
                                <div class="ban-box-com">
                                    ...
                                    <a href="#">View more <i class="fa fa-long-arrow-right"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study.jpg') }}" alt="img">
                                <h2>PCS-PRE</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-1.jpg') }}" alt="img">
                                <h2>SSC</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani1">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-2.jpg') }}" alt="img">
                                <h2>UPSSSC</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani2">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-3.jpg') }}" alt="img">
                                <h2>POLICE-SI</h2>
                            </div>
                        </div>
                    ...
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-4.jpg') }}" alt="img">
                                <h2>CTET TET</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-5.jpg') }}" alt="img">
                                <h2>PGT TGT</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani1">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-6.jpg') }}" alt="img">
                                <h2>UGC NET</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani2">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-7.jpg') }}" alt="img">
                                <h2>Bank Railways</h2>
                            </div>
                        </div>
                        <!-- <i class="pack-border"></i> -->
                    ...
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-8.jpg') }}" alt="img">
                                <h2>9th-12th <strong>Academic
                                        Class</strong></h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-9.jpg') }}" alt="img">
                                <h2>JEE-IIT <strong>Engg Entrance
                                        Exam</strong></h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani1">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-10.jpg') }}" alt="img">
                                <h2>NEET <strong>Medical Entrance
                                        Exam</strong></h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani2">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-11.jpg') }}" alt="img">
                                <h2>NDA <strong>National Defence
                                        Academy</strong></h2>
                            </div>
                        </div>
                        <!-- <i class="pack-border"></i> -->
                    ...
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-12.jpg') }}" alt="img">
                                <h2>PCS-PRE</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-13.jpg') }}" alt="img">
                                <h2>PCS-PRE</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani1">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-14.jpg') }}" alt="img">
                                <h2>SSC</h2>
                            </div>
                        </div>
                    </div>
                    <div class="ani-eql col-lg-3 col-md-6 packages-ani2">
                        <div class="most-packages">
                            <div class="packages-img">
                                <img src="{{ asset('website/assets/images/places/study-15.jpg') }}" alt="img">
                                <h2>UPSSSC</h2>
                            </div>
                        </div>
                        <!-- <i class="pack-border"></i> -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="ani-eql ask-exp-text">
                        ...
                        <span><i class="fa fa-check" aria-hidden="true"></i>The Climate Shift in 2022 Allows Venice
                            to Recover</span>
                        <span><i class="fa fa-check" aria-hidden="true"></i>New Must-See Architecture Designs in
                            Europe</span>
                        <span><i class="fa fa-check" aria-hidden="true"></i>Lacinia sociis morbi erat ultricies
                            dictumst</span>
                        <span><i class="fa fa-check" aria-hidden="true"></i>Lorem non sit vivamus convallis elit
                            mollis</span>
                    </div>
                        ...
                        <ul>
                            <li class="ani-eql">
                                <div class="traveller-point">
                                    ...
                                    <h4>Benefit <br> No.1 </h4>
                                </div>
                            </li>
                            <li class="ani-eql">
                                <div class="traveller-point">
                                    <i class="fa fa-bandcamp" aria-hidden="true"></i>
                                    <h4>Benefit <br> No.2 </h4>
                                </div>
                            </li>
                            <li class="ani-eql">
                                <div class="traveller-point">
                                    <i class="fa fa-suitcase" aria-hidden="true"></i>
                                    <h4>Benefit <br> No.3 </h4>
                                </div>
                            </li>
                            <li class="ani-eql">
                                <div class="traveller-point">
                                    <i class="fa fa-area-chart" aria-hidden="true"></i>
                                    <h4>Benefit <br> No.4 </h4>
                                </div>
                            </li>
                            <li class="ani-eql">
                                <div class="traveller-point">
                                    <i class="fa fa-area-chart" aria-hidden="true"></i>
                                    <h4>Benefit <br> No.5 </h4>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="important-information-news">
                                <div class="news-slider">
                                    <div class='marquee-vert'>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> The purpose of lorem ipsum is to create a
                                            natural looking block of text
                                            (sentence, paragraph, page, etc.)</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> The passage experienced a surge in popularity
                                            during</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> Until recently, the prevailing view assumed
                                            lorem ipsum was born as a</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> The placeholder text, beginning with the line
                                            “Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit”</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> In particular, the garbled words of lorem ipsum
                                            bear an unmistakable
                                            resemblance to sections 1.10.32–33</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> McClintock's eye for detail certainly helped
                                            narrow the whereabouts of lorem
                                            ipsum's origin, however,</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> So how did the classical Latin become so
                                            incoherent?</a>
                                        <a href="#" class="news-link"><i class="fa fa-arrow-right"
                                                aria-hidden="true"></i> Required text scrolling From bottom to top
                                            Required text scrolling From
                                            bottom to top</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                    ...
                    <div class="news-row d-flex mb-3">
                        <div class="news-img mr-3">
                            <img class="img-fluid" src="{{ asset('website/assets/images/information/study-7.jpg') }}"
                                alt="img">
                        </div>
                    ...
                    <div class="row flex-nowrap">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2 govt-web-col">
                            <div class="govt-web-logo">
                                <a href="#">
                                    <img class="img-fluid"
                                        src="{{ asset('website/assets/images/govt-web-logo/logo-1.png') }}"
                                        alt="img">
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        ...
                        <h2><span class="counter" data-count-start="50" data-count-end="80"
                                data-speed="70">80</span><span class="plus-icon">+</span></h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        ...
                        <h2><span class="counter" data-count-start="50" data-count-end="100"
                                data-speed="70">100</span><span class="plus-icon">+</span></h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        ...
                        <h2><span class="counter" data-count-start="50" data-count-end="150"
                                data-speed="70">150</span><span class="plus-icon">+</span></h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    <div class="counter-section-widget text-center">
                        ...
                        <h2><span class="counter" data-count-start="50" data-count-end="200"
                                data-speed="70">200</span><span class="plus-icon">+</span></h2>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="testi-lhs">
                                                        <div class="str-rating">
                                                            <div class="testimonials-user">
                                                                <img src="{{ asset('website/assets/images/testimonails/3.jpg') }}"
                                                                    alt="img">
                                                            </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="country-travel-1">
                                ...
                                <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Logo_of_IIT_Bhilai.png"
                                    alt="">
                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                <img class="img-fluid"
                                    src="{{ asset('website/assets/images/contributor/contributor-img.png') }}"
                                    alt="img">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                <img class="img-fluid"
