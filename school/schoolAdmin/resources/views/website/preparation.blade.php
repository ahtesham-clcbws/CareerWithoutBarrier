                                ...
                                <div class="course-layout-item">
                                    <div class="course-entry">
                                        ...
                                        <div class="course-cover">
                                            <div class="course-cover-thumb">
                                                <figure class="entry-thumb"><a class="post-thumbnail"
                                                        href="https://demoapus1.com/skillup/course/education-software-and-php-and-js-system-script/"
                                                        aria-hidden="true">
                                                        <div class="image-wrapper"><img
                                                                src="{{ asset('website/assets/images/prepration/bank-img.jpg') }}"
                                        ...
                                        <div class="course-layout-content">
                                            <h3 class="course-title"><a href="career_details.html">Education
                            ...
                            <div
                                ...
                                <div class="course-layout-item">
                                    <div class="course-entry">
                                        <div class="course-cover">
                                            <div class="course-cover-thumb">
                                                <figure class="entry-thumb"><a class="post-thumbnail" href="#"
                                                        aria-hidden="true">
