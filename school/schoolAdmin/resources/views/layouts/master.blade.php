        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li class="active"><a class="sidebar-sub-toggle"><i class="ti-home"></i> Home <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Classes <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li class="active"><a class="sidebar-sub-toggle"><i class="ti-home"></i> Courses <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-pencil-alt"></i>Students <span class="badge badge-primary">28</span><span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Result <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Notices <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Centers <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Enquiry <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="{{ route('enquiry.institute') }}">Institute</a></li>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Admin <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
    ...
    <div class="header">
        ...
        <div class="pull-right p-r-15">
            <ul>
                ...
                <li class="header-icon dib"><img class="avatar-img" src="assets/images/avatar/1.jpg" alt="" /> <span class="user-avatar">Vishal <i class="ti-angle-down f-s-10"></i></span>
