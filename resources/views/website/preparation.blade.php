                            ...
                            <div class="course-layout-item">
                                <div class="course-entry">
                                    ...
                                    <div class="course-layout-content">
                                        <h3 class="course-title"><a href="{{route('home.career',encodeId($featuredCourse->id))}}">Education
                                                {{$featuredCourse->course_full_name}} ( {{$featuredCourse->vacancies}} Vacancies)</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
