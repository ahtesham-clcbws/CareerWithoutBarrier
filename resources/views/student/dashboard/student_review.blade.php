                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="5" colspan="2" align="center">
                                                <div class="text-center" style="display: inline-grid;">
                                                    <img src="{{ explode('/', $student->photograph)[0] == 'student' ? '/storage/'.$student->photograph : '/upload/student/'.$student->photograph  }}" class="img-fluid" style="width: 160px;border: 1px double #dee2e6;padding: 4px;height: auto;">
                                                    <img src="{{ explode('/', $student->signature)[0] == 'student' ? '/storage/'.$student->signature : '/upload/student/'.$student->signature  }}" class="img-fluid" style="width: 160px;border: 1px double #dee2e6;padding: 4px;height: auto;">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
