                ...
                <section class="content admin-1 mt-3">
                    <div class="row corporate-cards">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="d-flex justify-content-between align-items-center p-2" style="background-color:#19467a ; color: white;">
                                            ...
                                            <table class="table table-bordered table-hover" id="studentTable">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="information-txt"> {{ $student->qualifications?->name ?? 'N/A' }} </td>
