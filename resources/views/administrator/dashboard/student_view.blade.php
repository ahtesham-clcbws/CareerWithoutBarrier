                     ...
                     <div class="card">
                        <div class="card-header" style="background-color:#19467a ; color: white;">
                           ...
                           <div style="display:flex; ">
                              <a href="{{ route('admin.print.studentView', $student->id) }}" target="_blank"><button type="button" style="display:flex; float:right;" class="btn btn-success"><i class="fa fa-print"></i></button></a>
                           </div>
                        </div>
                        <br>
                        <div class="card-body">
                              ...
                              <div class="table-responsive">
                                 <table class="table table-bordered table-hover" id="studentTable">
                                    <tbody>
                                       ...
                                       <tr>
                                          <td><b>Addres s</b></td>
                                          <td class="information-txt" colspan="3">{{$student->address}}</td>
                                       </tr>
                                       <tr>
                                          <td><b>State</b></td>
                                       ...
                                       <tr>
                                          <td> <b>Scholarship Opted For</b> </td>
                                          <td class="information-txt"> {{ $student->scholarShipOptedFor?->name ?? 'N/A' }}</td>
                                          <td>
                                          ...
                                          @php($center = DB::table('districts')->where('id',$student->test_center_a)->first())
                                           ...
                                           {{ $center->name }} / @if($student->choiceCenterB )@php($center2 = DB::table('districts')->where('id',$student->test_center_b)->first())<b>B:</b> {{ $center2->name }} @endif </td>
                                       </tr>
                                       <tr>
                                          <td>
                        ...
                        <div class="card-body">
                           ...
                           <div class="d-flex mb-2">
                              ...
                              <div class="box-input">
                                 ...
                                 <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="bi bi-person-fill"></i></span> <input type="text" name="name" class="form-control" value="{{$student->name}}" placeholder="Person name"> </div>
                              </div>
                           </div>
                           <div class="d-flex mb-2">
                              ...
                              <div class="box-input">
                                 <!-- <div class="box-icon"></div> -->
                                 <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="bi bi-phone"></i></span> <input type="text" name="mobile" class="form-control" value="{{$student->mobile}}" placeholder="Person name"> </div>
                              </div>
                           </div>
                           <div class="d-flex mb-2">
                              ...
                              <div class="box-input">
                                 <!-- <div class="box-icon"></div> -->
                                 <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="bi bi-envelope-fill"></i></span> <input type="email" class="form-control" value="{{$student->email}}" placeholder="E-mail" name="email" readonly=""> </div>
                              </div>
                           </div>
                           <div class="d-flex mb-2">
