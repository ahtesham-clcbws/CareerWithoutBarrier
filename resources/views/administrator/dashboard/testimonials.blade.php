            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <img src="{{ asset('home/' . $testimonial->image) }}" style="width: 100px;border-radius:10px"></td>
                        <td width="40%">{!! $testimonial->message !!}</td>
                        <td>
                            <div class="form-control2">
                                            <label class="switch" for="testimonial-{{ $testimonial->id }}">
                                                <input type="checkbox" id="testimonial-{{ $testimonial->id }}" data-id="{{ $testimonial->id }}" class="testimonial-status-toggle" {{ $testimonial->status ? 'checked' : '' }}>
