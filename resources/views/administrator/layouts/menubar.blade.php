    ...
    <ul class="navbar-nav dashboard2" id="menu1-top">
        ...
        <li class="nav-item" style="margin-right: 3px;">
            ...
            <div class="dropdown-content panel-collapse noti_box" style="display: none;">
                ...
                <ul>
                    <li>
                        <a href="#">
                            <img src="{{asset('images/watch.png')}}" class="noti_icon">
        ...
        <li class="nav-item">
            ...
            <div class="dropdown-content panel-collapse profile-noti">
                ...
                <ul>
                    <li><a href="{{route('admin.profile')}}"><i class="fa fa-user" aria-hidden="true"></i> <span> Profile</span></a></li>
                    <li><a href="{{route('admin.changePassword')}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span> Change Password</span></a></li>

                    <li class="last_rad"><a href="{{route('admin.logout')}}"><i class="fa fa-sign-out" aria-hidden="true"></i><span> Sign Out</span></a></li>
                </ul>
            </div>
        </li>
    </ul>
