...
<table id="customers" style="width:95%;">
                                       ...
                                       <tr>
                                          ...
                                          <td class="information-txt" colspan="2"><b>A:</b> {{ $student->choiceCenterA?->DistrictName }} / @if($student->choiceCenterB )<b>B:</b> {{ $student->choiceCenterB?->DistrictName }} @endif </td>
                                       </tr>
                                       <tr>
                                          <td>
